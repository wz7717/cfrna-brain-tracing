...
Zhen Wang^1, Li Zhang^1, Zheng Wang^2
...
**Supplementary information:** Supplementary data are available at Bioinformatics online. The submitted supplementary file contains Supplementary Methods, Supplementary Results and Tables S1-S6. The Markdown source, figure source data and synthetic public example input/output files are archived in the GitHub/Zenodo release.
...
This work was supported by the National Natural Science Foundation of China (NSFC) under grant number 32370682, and Capital Health Development Research Special Project (Shou Fa 2026-1Q-1114).
