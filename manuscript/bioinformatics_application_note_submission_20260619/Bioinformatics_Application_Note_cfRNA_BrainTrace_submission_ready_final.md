...
Supplementary Methods, Supplementary Results and Tables S1-S6 are provided as a single supplementary PDF, `Bioinformatics_Application_Note_Supplementary_File_submission_20260619.pdf`. The Markdown source, figure source data and synthetic public example input/output files are archived in the GitHub/Zenodo release.
