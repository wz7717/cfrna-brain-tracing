...
Validation was matched to available label resolution. Internal experiments first tested projected-VSD representation for broad Network beam generation. In fold-local LOSO Network validation, projected VSD achieved Top1/Top3 accuracy of 58.00%/91.58%, exceeding logCPM baseline and native VSD routes; in strict LOMO validation it reached 53.72%/91.33%. Direct exact-region projected-VSD scoring was lower and less stable, so exact-region scoring was not used as the sole endpoint.
