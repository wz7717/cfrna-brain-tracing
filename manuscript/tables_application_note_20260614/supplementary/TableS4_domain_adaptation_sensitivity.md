| Route | Analysis role | Uses target unlabeled distribution | Uses paired labels internally | Network Top-1 tolerant | Network Top-3 tolerant | Broad Top-3 tolerant |
| --- | --- | --- | --- | --- | --- | --- |
