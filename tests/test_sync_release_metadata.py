...
def test_release_manifest_rejects_substitute_reserved_doi() -> None:
    manifest = {
        "version": "0.1.18", "tag": "v0.1.18", "scientific_frozen": True,
        ...
        "previous_release": {
            ...
            "git_sha": "2cceaea5c42979689e96f97f75b66eaaeafa4629",
            "software_version_doi": "10.5281/zenodo.22006038",
            "full_repro_version_doi": "10.5281/zenodo.22005947",
            "immutable": True,
        },
        "creators": [{"name": "Author"}], "title": "BrainTrace", "description": "Stable description",
    }
    errors = validate_manifest(manifest)
    assert "full-repro DOI is not the reserved v0.1.18 draft DOI" in errors
