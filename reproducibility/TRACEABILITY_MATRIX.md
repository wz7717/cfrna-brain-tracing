...
| ID | Manuscript Location | Manuscript Value | Source CSV | Availability | CSV Location | Formula | Raw Data Input | ✓ |
|----|-------------------|-----------------|------------|--------------|-------------|---------|---------------|---|
| T044 | Supp Table S8/S13 | LOSO Exact macro F1 = 0.2102 | `v4_p0_13_macro_f1.csv` | Submission package only | SUMMARY, LOSO_Exact_macro | mean(F1_i) for i=1..105 | 105 class-level F1 from LOSO Exact confusion matrix | ✓ |
| T045 | Supp Table S8/S13 | LOMO Exact macro F1 = 0.1943 | `v4_p0_13_macro_f1.csv` | Submission package only | SUMMARY, LOMO_Exact_macro | mean(F1_i) for i=1..104 | 104 class-level F1 from LOMO Exact confusion matrix | ✓ |
| T046 | Supp Table S8 | LOSO Network macro F1 | `v4_p0_13_macro_f1.csv` | Submission package only | SUMMARY, LOSO_Network_macro | mean(F1_i) for i=1..10 | 10 Network class-level F1 from LOSO confusion matrix | ✓ |
| T047 | Supp Table S8 | LOMO Network weighted F1 | `v4_p0_13_macro_f1.csv` | Submission package only | SUMMARY, LOMO_Network_weighted | Σ(n_i·F1_i) / Σ(n_i) for i=1..10 | 10 Network classes with sample counts from LOMO | ✓ |
